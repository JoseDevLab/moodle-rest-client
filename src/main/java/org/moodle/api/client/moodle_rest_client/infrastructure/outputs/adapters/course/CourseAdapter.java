...
public class CourseAdapter implements CoursePort {
    ...
    public List<Course> createCourses(List<CreateCourseRequest> coursesToCreate) {
        ...
        CourseDTO[] createdCourses = moodleHttpClient.call(CREATE_COURSES_FUNCTION, requestBody, CourseDTO[].class);
    ...
    public List<Course> searchCoursesByField(String field, String value) {
        ...
        GetCoursesByFieldResponseDTO response = moodleHttpClient.call(GET_COURSES_BY_FIELD_FUNCTION, requestBody, GetCoursesByFieldResponseDTO.class);
    ...
    public void updateCourses(List<UpdateCourseRequest> coursesToUpdate) {
        ...
        moodleHttpClient.call(UPDATE_COURSES_FUNCTION, requestBody, Void.class);
    }
    ...
    public void deleteCourses(List<Long> courseIds) {
        ...
        moodleHttpClient.call(DELETE_COURSES_FUNCTION, requestBody, Void.class);
    }
    ...
    public List<Section> getCourseContents(Long courseId) {
        ...
        SectionDTO[] response = moodleHttpClient.call(GET_COURSE_CONTENTS_FUNCTION, requestBody, SectionDTO[].class);
    ...
    public CourseModule getCourseModule(Long courseModuleId) {
        ...
        GetCourseModuleResponseDTO response = moodleHttpClient.call(GET_COURSE_MODULE_FUNCTION, requestBody, GetCourseModuleResponseDTO.class);
    ...
    public CourseSearch searchCourses(String searchText, int page, int perPage) {
        ...
        CourseSearchResponseDTO response = moodleHttpClient.call(SEARCH_COURSES_FUNCTION, requestBody,
    ...
    public List<Course> getCoursesById(List<Long> courseIds) {
        ...
        CourseDTO[] response = moodleHttpClient.call(GET_COURSES_FUNCTION, requestBody, CourseDTO[].class);
    ...
    public Course duplicateCourse(DuplicateCourseRequest request) {
        ...
        CourseDTO response = moodleHttpClient.call(DUPLICATE_COURSE_FUNCTION,
    ...
    public void importCourse(ImportCourseRequest request) {
        ...
        moodleHttpClient.call(IMPORT_COURSE_FUNCTION,
                (Map<String, Object>) objectMapper.convertValue(requestDTO, Map.class),
                Void.class);
    }
}
