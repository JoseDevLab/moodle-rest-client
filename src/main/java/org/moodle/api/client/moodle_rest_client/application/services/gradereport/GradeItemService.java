...
public class GradeItemService implements GetGradeItemsUseCase {
    ...
    @Override
    public GradeItems getUserGradeItems(MoodleCredentials moodleCredentials, Long courseId) {
        return gradeItemPort.getUserGradeItems(moodleCredentials, courseId);
    }

    @Override
    public GradeItems getUserGradeItems(MoodleCredentials moodleCredentials, GetGradeItemsRequest request) {
        return gradeItemPort.getUserGradeItems(moodleCredentials, request);
    }
}