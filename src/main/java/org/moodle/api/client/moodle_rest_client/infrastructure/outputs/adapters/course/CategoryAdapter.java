...
public class CategoryAdapter implements CategoryPort {
    ...
    public List<Category> getCourseCategories(MoodleCredentials moodleCredentials) {
        CategoryDTO[] categoryDTOS = moodleHttpClient.call(
    ...
    public List<Category> createCategories(MoodleCredentials moodleCredentials, List<CreateCategoryRequest> categoriesToCreate) {
        ...
        CategoryDTO[] createdCategories = moodleHttpClient.call(
                moodleCredentialsMapper.toDTO(moodleCredentials),
    ...
    @Override
    public List<Category> searchCategories(MoodleCredentials moodleCredentials, SearchCategoryRequest searchCategoryRequest) {
