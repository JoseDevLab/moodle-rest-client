...
public class GradeItemAdapter implements GradeItemPort {
    ...
    public GradeItems getUserGradeItems(MoodleCredentials moodleCredentials, Long courseId) {
        ...
        UserGradesResponseDTO responseDto = moodleHttpClient.call(
                moodleCredentialsMapper.toDTO(moodleCredentials),
                GRADEREPORT_USER_GET_GRADE_ITEMS,
                params,
                UserGradesResponseDTO.class
        );
    ...
    @Override
    public GradeItems getUserGradeItems(MoodleCredentials moodleCredentials, GetGradeItemsRequest request) throws MoodleApiException {
